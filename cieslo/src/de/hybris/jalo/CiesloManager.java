...
/**
 * This is the extension manager of the Cieslo extension.
 */
public class CiesloManager extends GeneratedCiesloManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CiesloManager.class);
	 ...
	 */
	public static CiesloManager getInstance()
	{
		return (CiesloManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CiesloConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CiesloManager() // NOPMD 
	{
		LOG.debug("constructor of CiesloManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CiesloManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CiesloManager called, current tenant: {}", getTenant().getTenantID());
	}
