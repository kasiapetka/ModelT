...
public class DefaultCiesloService implements CiesloService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCiesloService.class);
	...
	{
		return DefaultCiesloService.class.getResourceAsStream("/cieslo/sap-hybris-platform.png");
	}
