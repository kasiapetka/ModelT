...
public class DefaultEntryNumberFixService implements EntryNumberFixService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultEntryNumberFixService.class);
	...
	{
		return DefaultEntryNumberFixService.class.getResourceAsStream("/entryNumberFix/sap-hybris-platform.png");
	}
