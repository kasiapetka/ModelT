...
public class DefaultReactorFixService implements ReactorFixService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultReactorFixService.class);
	...
	{
		return DefaultReactorFixService.class.getResourceAsStream("/reactorFix/sap-hybris-platform.png");
	}
