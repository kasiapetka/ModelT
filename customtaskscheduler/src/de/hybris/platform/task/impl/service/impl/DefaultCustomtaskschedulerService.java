...
public class DefaultCustomtaskschedulerService implements CustomtaskschedulerService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomtaskschedulerService.class);
	...
	{
		return DefaultCustomtaskschedulerService.class.getResourceAsStream("/customtaskscheduler/sap-hybris-platform.png");
	}
